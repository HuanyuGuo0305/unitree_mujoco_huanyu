...
aligned with the new direct-command high-gains training setup.

Run from simulate_python/:

    python3 deploy_mujoco/b2wz1_loco_manipulation_directcmd_highgains.py configs/b2wz1_loco_manipulation_directcmd_highgains.yaml --mode pd-stand
    python3 deploy_mujoco/b2wz1_loco_manipulation_directcmd_highgains.py configs/b2wz1_loco_manipulation_directcmd_highgains.yaml --mode lock-arm-policy
    python3 deploy_mujoco/b2wz1_loco_manipulation_directcmd_highgains.py configs/b2wz1_loco_manipulation_directcmd_highgains.yaml --mode full-policy
"""
...
class PresampledKeypointsDirectCommandLBSim:
    ...
    def _sample_new_command(self):
        self.keypoints_command_lb = self._table[self._pick_index()].copy().astype(np.float32)
        self._step_in_cycle = 0
        self._has_cmd = True
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("B2WZ1 Loco-Manipulation - ONNX Policy (MuJoCo sim2sim, directcmd highgains)")
    print("=" * 80)
    ...
    if ee_command_mode == "sequential":
        ...
        ee_cmd_sampler = PresampledKeypointsDirectCommandLBSim(
            file_path=ee_command_path,
            control_dt=control_dt,
