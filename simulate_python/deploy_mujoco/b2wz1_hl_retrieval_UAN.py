...
The high-level policy is unchanged relative to its Isaac Lab training interface:
...
Run from unitree_mujoco/simulate_python:
    ...
    python3 deploy_mujoco/b2wz1_hl_retrieval_UAN.py configs/b2wz1_hl_retrieval_UAN.yaml
"""
...
def main():
    ...
    print("=" * 88)
    print("B2WZ1 Retrieval - Hierarchical WBC + UAN MuJoCo sim2sim")
